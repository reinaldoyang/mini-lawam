...
### Phase2 訓練指令（input的路徑記得改）
```bash
CUDA_VISIBLE_DEVICES=0 python -m mini_lawam.train \
  --hdf5 /home/iclu200/gary/ur7e_teleoperate_meta_quest3/datasets/real_data/test_0818_1322_256.hdf5 \
  --phase 2 --head attn --gripper-head binary \
  --use-wrist --target joystick --include-rz --include-ry \
  --gripper-target-offset 1 --include-tail-actions \
  --prior-ckpt results/mini_lawam/phase1_test_0818_1322_256.pt \
  --lambda-gripper 1.0 \
  --steps 10000 --batch 32 --lr 1e-4 \
  --out results/mini_lawam/ckpt_test_0818_1322_256_attn_ry_rz_binary_grip_t1.pt \
  --csv-log results/mini_lawam/log_test_0818_1322_256_attn_ry_rz_binary_grip_t1.csv
